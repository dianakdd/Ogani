            ...
            <div class="navbar-content scroll-div ">
                ...
                <div class="">
                    <div class="main-menu-header">
                        <img class="img-radius" src="/dashboard/assets/images/user/avatar-2.jpg"
                ...
                <ul class="nav pcoded-inner-navbar ">
                    ...
                    <li class="nav-item">
                        <a href="/admin" class="nav-link "><span class="pcoded-micon"><i
                                    class="feather icon-home"></i></span><span class="pcoded-mtext">Product</span></a>
                    </li>
                    <li class="nav-item">
                        <a href="/admin/order" class="nav-link "><span class="pcoded-micon"><i
            ...
            <li>
                <div class="dropdown drp-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-right profile-notification">
                        <div class="pro-head">
                            <img src="/dashboard/assets/images/user/avatar-1.jpg" class="img-radius"
                                alt="User-Profile-Image">
                            <span>{{ Auth::user()->name }}</span>
